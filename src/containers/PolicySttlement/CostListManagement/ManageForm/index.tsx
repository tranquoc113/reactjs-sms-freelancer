      ...
      >
        <Row gutter={24}>
          <Col xs={24} sm={24} md={12} lg={7}>
            <SelectField
              label={t('policy_settlement.active_agency')}
              field={getFieldProps('active_agency')}
              optionsSelect={ACTIVE_AGENCY(t)}
              setFieldValue={setFieldValue}
              labelCol={{ xs: 24, md: 8, lg: 8 }}
              wrapperCol={{ xs: 24, md: 16, lg: 16 }}
              labelAlign="left"
              error={errors.active_agency}
              touched={touched.active_agency}
            />
          </Col>
