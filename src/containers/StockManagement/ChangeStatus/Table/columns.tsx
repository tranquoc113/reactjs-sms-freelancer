...
const columns: App.ColumnsFnc<Response.ChangeStatus> = (t) => [
  ...
  {
    title: t('stock_management.change_status.status'),
    dataIndex: 'status',
    className: 'cell-nowrap',
  },
  {
    title: t('stock_management.change_status.process_date'),
    dataIndex: 'processDate',
    className: 'cell-nowrap',
    render(text) {
      return formatDate(text, 'YYMMDD');
    },
  },
  {
  ...
  {
    title: t('stock_management.change_status.note'),
    dataIndex: 'note',
    className: 'cell-nowrap',
  },
  {
  ...
  {
    title: t('stock_management.change_status.unique_number'),
