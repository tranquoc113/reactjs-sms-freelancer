...
export const STATE_CLS: App.OptionsFnc = (t) => [
  {
    label: t('stock_management.delivery_check.state_normal'),
    value: 'normal',
  },
  {
    label: t('stock_management.delivery_check.state_distribution_phone'),
    value: 'distribution_phone',
  },
  {
    label: t('stock_management.delivery_check.state_used'),
    value: 'used',
  },
];
