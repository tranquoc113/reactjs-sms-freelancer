...
import { fetchResources } from 'src/useCase/registerShipment';
import { PER } from 'src/constants/app';

export const PATH = '/stock/register-shipment' as const;
...
const Page: React.FC<IRouter> = (props) => {
  return (
    <AppPage
      route={props}
      PATH={PATH}
      factory={() => import('src/containers/StockManagement/RegisterShipment')}
